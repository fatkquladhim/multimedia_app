...
<body class="gradient-bg dark-mode-transition">
                        ...
                        <div class="space-y-4">
                            <?php if ($izin_malam_anggota->num_rows > 0): ?>
                                <?php while ($row = $izin_malam_anggota->fetch_assoc()): ?>
                                    <div class="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 p-4 bg-light-blue-50 dark:bg-light-blue-900 rounded-xl hover:scale-105 transition">
    <!-- Kolom Kiri: Nama -->
    ...
    <div class="w-full md:w-3/4 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center md:text-left">
        <div>
            <h4 class="font-semibold text-gray-800 dark:text-white">
                Tanggal: <br>
