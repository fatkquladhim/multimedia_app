...
<body class="bg-amber-50">
    <div class="min-h-screen flex">
        ...
        <div class="w-80 bg-white p-6 shadow-lg flex-shrink-0">
            <div class="text-center mb-6">
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-2">You have 5 days left on your subscription</h3>
            ...
            <div class="mt-8">
                <div class="w-20 h-20 bg-orange-400 rounded-full mx-auto flex items-center justify-center shadow-lg">
