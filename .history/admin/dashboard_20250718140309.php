                        ...
                        <div class="space-y-4">
                            <?php if ($izin_malam_anggota->num_rows > 0): ?>
                                <?php while ($row = $izin_malam_anggota->fetch_assoc()): ?>
                                    <div class="p-4 bg-light-blue-50 dark:bg-light-blue-900 rounded-xl hover:scale-105 transition space-y-4">
    <!-- Baris Nama -->
    <div class="flex flex-col sm:flex-row sm:items-center gap-2">
        <h4 class="font-semibold text-gray-800 dark:text-white w-24">Nama:</h4>
        <p class="text-gray-800 dark:text-white"><?php echo htmlspecialchars($row['nama']); ?></p>
    </div>

    <!-- Baris Tanggal -->
    <div class="flex flex-col sm:flex-row sm:items-center gap-2">
        <h4 class="font-semibold text-gray-800 dark:text-white w-24">Tanggal:</h4>
        <p class="text-gray-800 dark:text-white"><?php echo date('d M Y', strtotime($row['tanggal'])); ?></p>
    </div>

    <!-- Baris Jam -->
    <div class="flex flex-col sm:flex-row sm:items-center gap-2">
        <h4 class="font-semibold text-gray-800 dark:text-white w-24">Jam:</h4>
        <p class="text-gray-800 dark:text-white">
            <?php echo htmlspecialchars($row['jam_izin']); ?> - <?php echo htmlspecialchars($row['jam_selesai_izin']); ?>
        </p>
    </div>

    <!-- Baris Alasan -->
    <div class="flex flex-col sm:flex-row sm:items-center gap-2">
        <h4 class="font-semibold text-gray-800 dark:text-white w-24">Alasan:</h4>
        <p class="text-gray-800 dark:text-white"><?php echo htmlspecialchars($row['alasan']); ?></p>
    </div>
</div>
