...
<body>
    ...
    <form method="POST">
        ...
        <div>
            ...
            <input type="time" name="jam_izin" value="<?php echo $izin['jam_izin']; ?>" required>
        </div>
        
        <div>
            <label>Jam Selesai Izin:</label><br>
            <input type="time" name="jam_selesai_izin" value="<?php echo $izin['jam_selesai_izin']; ?>" required>
        </div>
