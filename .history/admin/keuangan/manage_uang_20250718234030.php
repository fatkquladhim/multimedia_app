...
// Ambil data otomatis dari penyewaan
$auto_pengeluaran_query = "SELECT tanggal_kembali as tanggal, biaya as pengeluaran, CONCAT('Otomatis dari penyewaan ID: ', id) as keterangan_pengeluaran 
...
while ($row = $auto_result->fetch_assoc()) {
    ...
    $stmt->bind_param("siissi", $tanggal, 0, $pengeluaran, '', $keterangan_pengeluaran, $saldo_akhir);
    $stmt->execute();
}
