        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="number" name="pemasukan" class="form-control"  value="<?= htmlspecialchars($data_keuangan['pemasukan']) ?>">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label>Pengeluaran:</label>
                    <input type="number" name="pengeluaran" class="form-control"  value="<?= htmlspecialchars($data_keuangan['pengeluaran']) ?>">
                </div>
            </div>
        </div>
