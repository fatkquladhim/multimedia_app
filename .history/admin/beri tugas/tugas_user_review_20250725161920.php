...
<div class="min-h-screen from-blue-50 to-indigo-100 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Tombol Tolak Tugas -->
        <form action="tugas_user_review_store.php" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menolak tugas ini? Status akan diubah menjadi pending dan nilai akan direset.');" class="w-full sm:w-auto">
            <input type="hidden" name="id_tugas" value="<?php echo $tugas['tugas_id']; ?>">
