...
try {
    ...
    $stmt_all_anggota = $conn->prepare("SELECT id, nama, nim, email, no_hp FROM anggota 
                                       ORDER BY nama LIMIT ?, ?");
                ...
                <table class="min-w-full bg-white dark:bg-slate-800">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b border-gray-200 dark:border-gray-700 text-left text-gray-600 dark:text-gray-300">NIM</th>
                        ...
                        <?php if ($all_anggota->num_rows > 0): ?>
                            <?php while($row = $all_anggota->fetch_assoc()): ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700"><?php echo htmlspecialchars($row['nim']); ?></td>
