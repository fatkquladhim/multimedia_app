        ...
        <div id="mainContentArea" class="flex-1 flex flex-col main-content-area">
            ...
            <main class="flex-1 p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">tugas riview</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-purple-50 rounded-2xl p-6 relative overflow-hidden">
                        ...
                        <h3 class="text-xl font-bold text-purple-700 mb-2">nahwu</h3>
                        <p class="text-gray-700 mb-4">dari fatkqul adhim</p>
                        <div class="text-sm text-gray-600 mb-2">status</div>
                        <div class="flex items-center justify-between">
                           <button><a href="">nilai</a></button> 
                        </div>
                    </div>
