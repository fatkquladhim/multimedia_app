...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $stmt = $conn->prepare("SELECT pb.*, a.nama as nama_anggota, al.nama as nama_alat 
...
$query_alat = "SELECT id, nama, jumlah FROM alat ORDER BY nama";
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <?php if ($peminjaman['tipe_peminjam'] === 'umum'): ?>
                    ...
                    (<?php echo htmlspecialchars($peminjaman['kontak_peminjam']); ?>)
                <?php else: ?>
