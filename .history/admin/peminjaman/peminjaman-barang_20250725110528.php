            ...
            <div class="p-8">
                <form method="POST" class="space-y-6">
                    ...
                    <div class="pt-6 border-t border-gray-200">
                        <button type="submit" 
                                class="w-full  glass-header hover:bg-blue-dark text-grey px-8 py-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 shadow-md hover:shadow-lg text-lg font-medium">
