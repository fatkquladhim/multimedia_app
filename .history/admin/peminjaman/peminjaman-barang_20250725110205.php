                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="date" name="tanggal_pinjam" value="<?php echo date('Y-m-d'); ?>" required
                                       class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-primary focus:border-blue-primary transition-all duration-200"  <i class="fas fa-calendar-alt text-gray-400"></i>>
