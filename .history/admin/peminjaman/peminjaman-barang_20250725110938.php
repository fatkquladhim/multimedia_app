            ...
            <div class="p-8">
                <form method="POST" class="space-y-6">
                    ...
                    <div class="pt-6 border-t border-gray-200">
                        <button type="submit" 
                                class="w-rounded px-4 py-2 bg-light-blue-600 hover:bg-light-blue-700 text-white rounded-lg text-sm font-medium transition-colors transition-all duration-200 flex items-center justify-center space-x-2 shadow-md hover:shadow-lg text-lg font-medium">
