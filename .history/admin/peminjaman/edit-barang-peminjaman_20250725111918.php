            ...
            <div class="p-8">
                <form method="POST" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" 
                                class="bg-blue-300 hover:bg-blue-dark text-white px-8 py-3 rounded-lg transition-all duration-200 flex items-center space-x-2 shadow-md hover:shadow-lg">
