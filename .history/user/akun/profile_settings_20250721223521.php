    ...
    <div class="container mx-auto px-4 flex justify-center">
        <div class="max-w-xl w-full bg-white rounded-xl shadow-lg p-8 space-y-8">
            ...
            <div class="bg-gray-50 p-6 rounded-lg shadow-inner">
                ...
                <form method="post" action="profile_update.php" class="space-y-5  flex-colomn justify-center align-center">
                    ...
                    <div class="flex justify-center pt-4">
                        <button type="submit" class="btn-primary w-full">Update Profil</button>
                    </div>
                </form>
            </div>
            ...
            <div class="bg-gray-50 p-6 rounded-lg shadow-inner">
                ...
                <form method="post" action="profile_update.php" class="space-y-5">
                    ...
                    <div class="flex justify-center pt-4">
                        <button type="submit" class="btn-primary w-full">Ubah Sandi</button>
                    </div>
                </form>
            </div>
        </div>
