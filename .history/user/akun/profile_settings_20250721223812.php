        ...
        <div class="max-w-xl w-full bg-white rounded-xl shadow-lg p-8 space-y-8">
            ...
            <div class="bg-gray-50 p-6 rounded-lg shadow-inner flex-colomn justify-center align-center">
                ...
                <form method="post" action="profile_update.php" class="space-y-5">
                    ...
                    <div class="flex justify-center pt-4">
                        <button type="submit" class="login-btn w-full py-2 font-semibold rounded-full focus:outline-none glass-header px-6 py-4 text-white relative z-10">Update Profil</button>
                    </div>
                </form>
            </div>
            ...
            <div class="bg-gray-50 p-6 rounded-lg shadow-inner flex-colomn justify-center align-center">
                ...
                <form method="post" action="profile_update.php" class="space-y-5">
                    ...
                    <div class="flex justify-center pt-4">
                        <button type="submit" class="login-btn w-full py-2 font-semibold rounded-full focus:outline-none glass-header px-6 py-4 text-white relative z-10">Ubah Sandi</button>
                    </div>
                </form>
            </div>
        </div>
