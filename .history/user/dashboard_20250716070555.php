                 ...
                 <div class="space-y-4">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        <h4 class="text-lg font-semibold text-gray-800">Next in Fashion</h4>
                                        <div class="flex items-center space-x-2">
                                            <span class="text-sm text-gray-600">Public</span>
                                            <div class="w-3 h-3 bg-purple-600 rounded-full"></div>
                                        </div>
                                    </div>
                                    <p class="text-gray-600 text-sm mb-2">Sed accusam voluptua non periudit, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                    <div class="flex items-center justify-between">
                        ...
                        <div class="bg-white rounded-2xl p-6 border border-gray-200 card-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-2">
                                        <h4 class="text-lg font-semibold text-gray-800">Digital Marketing Today</h4>
                                        <div class="flex items-center space-x-2">
