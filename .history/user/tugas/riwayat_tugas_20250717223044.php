        ...
        <div class="flex h-screen">
            ...
            <div class="flex-1 p-2">
                <header class="bg-white border-b border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-gray-800">Riwayat Tugas</h1>
                ...
                <main class="p-6">
                    ...
                    <p class="mb-4"><a href="tugas_user.php" class="text-blue-600 hover:underline">Kembali ke Tugas Saya</a> | <a href="../dashboard.php" class="text-blue-600 hover:underline">Kembali ke Dashboard</a></p>
