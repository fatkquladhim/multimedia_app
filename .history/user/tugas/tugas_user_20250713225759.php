...
<table border="1" cellpadding="5">
    ...
    <tr>
        ...
        <td>
            <a href="tugas_edit.php?id=<?php echo $row['id']; ?>">Ubah</a> |
            <a href="tugas_hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Yakin ingin menghapus tugas ini?')">Hapus</a> |
