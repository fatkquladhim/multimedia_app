 <div id="sidebar" class="w-64 bg-white dark:bg-slate-800 shadow-xl flex-shrink-0 sidebar transition-all duration-300 overflow-hidden glass-effect">
     ...
     <nav class="space-y-2 flex-1">
         <a href="../dashboard.php" class="flex items-center space-x-3 px-4 py-3 text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-xl sidebar-nav-item transition-colors">
         ...
         <a href="../tugas/riwayat_tugas.php"  class="flex items-center space-x-3 px-4 py-3 text-white-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg sidebar-nav-item">
             <i class="fas fa-history flex-shrink-0"></i>
             <span class="font-medium sidebar-text">Riwayat Tugas</span>
         </a>
         <a href="../akun/profile_settings.php" class="flex items-center space-x-3 px-4 py-3 text-white-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg sidebar-nav-item">
