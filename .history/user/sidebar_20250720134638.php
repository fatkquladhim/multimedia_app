 <div id="sidebar" class="w-64 bg-white dark:bg-slate-800 shadow-xl flex-shrink-0 sidebar transition-all duration-300 overflow-hidden glass-effect">
     ...
     <nav class="space-y-2 flex-1">
         ...
         <a href="../tugas/riwayat_tugas.php"  class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:text-blue-800 hover:bg-gray-100 rounded-lg sidebar-nav-item">
