...
$user_query = $conn->prepare('SELECT username, nama_lengkap, foto FROM users WHERE id = ?');
$user_query->bind_param('i', $id_user);
$user_query->execute();
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center space-x-2">
                                <div class="w-10 h-10 bg-white-600 rounded-full flex items-center justify-center">
                                    <img src="<?php echo htmlspecialchars($user_data['foto']); ?>" alt="Profile Picture" style="border-radius: 50%;">
                                </div>
                                <div class="flex items-center space-x-1">
                                    <a href="./profile/profile_view.php">
                                        <span class="font-medium text-gray-800"><?php echo htmlspecialchars($user_data['nama_lengkap']); ?></span>
