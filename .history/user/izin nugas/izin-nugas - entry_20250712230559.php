...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO izin_nugas (id_anggota, tanggal, alasan) VALUES ('$id_anggota', '$tanggal', '$alasan')";
    if ($conn->query($sql) === TRUE) {
        $success = 'Pengajuan izin nugas berhasil disimpan!';
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Pengajuan Izin Nugas</title>
    <style>
        ...
        input, textarea { width: 100%; padding: 8px; margin: 8px 0 16px; border: 1px solid #ccc; border-radius: 4px; }
...
<body>
<div class="container">
    <h2>Form Pengajuan Izin Nugas</h2>
    <?php if ($success): ?>
