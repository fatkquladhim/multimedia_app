                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 card-hover animate-fade-in">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <a href="./izin malam/izin-malam-entry.php" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-white-500 text-gray-600 transition-colors text-sm font-medium">
