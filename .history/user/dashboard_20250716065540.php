...
<body>
    ...
    ?>
            ...
            ?>
                        ...
                        <h3 class="text-xl font-bold text-purple-700 mb-2"><?php echo htmlspecialchars($row['judul']); ?></h3>
                        <p class="text-gray-700 mb-4"><?php echo nl2br(htmlspecialchars($row['deskripsi'])); ?></p>
                        <div class="text-sm text-gray-600 mb-2"><?php echo date('d/m/Y', strtotime($row['deadline'])); ?></div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700"><?php 
                    ...
                    ?></span>
                            <span class="text-sm font-bold text-purple-700"><?php if (!$row['jawaban_id']): // If no answer submitted yet ?>
