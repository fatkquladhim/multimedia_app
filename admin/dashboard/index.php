...
<aside class="sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
  ...
  <ul class="categories list-unstyled">
    ...
    <li class="has-dropdown">
      <i class="uil-calendar-alt"></i><a href="#"> alat</a>
      <ul class="sidebar-dropdown list-unstyled">
        <li><a href="../alat-assets/daftar-alat.php">daftar alat</a></li>
        <li><a href="../alat-assets/peminjaman-barang.php">peminjaman</a></li>
        <li><a href="../alat-assets/penyewaan-barang.php">penyewaan</a></li>
        <li><a href="../alat-assets/riwayat-peminjaman-barang.php">laporan alat</a></li>
        <li><a href="../alat-assets/edit-barang.php">pengaturan alat</a></li>
      </ul>
    </li>
    <li class="has-dropdown">
      <i class="uil-envelope-download fa-fw"></i><a href="#"> izin</a>
      <ul class="sidebar-dropdown list-unstyled">
        <li><a href="../izin-assets/izin_malam/izin-malam.php">izin malam</a></li>
        <li><a href="../izin-assets/izin_nugas/izin-nugas.php">izin nugas</a></li>
        <li><a href="../izin-assets/anggota/anggota.php">atur izin</a></li>
        <li><a href="../izin-assets/dashboard.php">laporan</a></li>
        <li><a href="../izin-assets/anggota/anggota-entry.php">pengaturan</a></li>
      </ul>
    </li>
    <li class="has-dropdown">
      <i class="uil-shopping-cart-alt"></i><a href="#"> keuangan</a>
      <ul class="sidebar-dropdown list-unstyled">
        <li><a href="../keuangan-assets/masuk.php">uang masuk</a></li>
        <li><a href="../keuangan-assets/keluar.php">uang keluar</a></li>
        <li><a href="../keuangan-assets/index.php">laporan keuangan</a></li>
        <li><a href="../keuangan-assets/edit.php">pengaturan keuangan</a></li>
      </ul>
    </li>
    <li class="has-dropdown">
      <i class="uil-setting"></i><a href="#"> manage</a>
      <ul class="sidebar-dropdown list-unstyled">
        <li><a href="../admin/beri_tugas_form.php">beri tugas</a></li>
        <li><a href="../user/profile_view.php">kelola pengguna</a></li>
        <li><a href="../admin/tugas_selesai_riwayat.php">riwayat tugas</a></li>
        <li><a href="../public/legalisasi_detail.php">legalisasi laptop</a></li>
      </ul>
    </li>
  </ul>
</aside>
    ...
    <div class="container-fluid mx-2">
      ...
      <div class="collapse navbar-collapse" id="toggle-navbar">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <button id="theme-toggle" class="btn btn-sm btn-outline-secondary" title="Toggle dark/light mode">
              <i class="uil-moon" id="theme-icon"></i>
            </button>
          </li>
          <li class="nav-item">
...
<!-- partial -->
  ...
  <style>
    ...
    body.dark-mode .sidebar, body.dark-mode .box, body.dark-mode .chart-container, body.dark-mode .admin, body.dark-mode .navbar, body.dark-mode .welcome .content {
    ...
    body.dark-mode .sidebar .sidebar-header, body.dark-mode .sidebar .categories, body.dark-mode .sidebar {
      background: #242526 !important;
      color: #e4e6eb !important;
    }
    ...
    body.dark-mode .btn, body.dark-mode .btn-outline-secondary {
    ...
    body.dark-mode .uil-moon:before { content: "\ebc9"; }
    body.dark-mode .uil-sun:before { content: "\eb26"; }
