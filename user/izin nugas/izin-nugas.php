...
// Ambil data riwayat izin nugas
$sql = "SELECT izin_nugas.*, anggota.nama FROM izin_nugas JOIN anggota ON izin_nugas.id_anggota = anggota.id ORDER BY tanggal DESC";
...
<body>
<div class="container">
    <h2>Riwayat Pengajuan Izin Nugas</h2>
    <a href="izin-nugas - entry.php" class="button">Ajukan Izin Nugas</a>
    <table>
        <tr>
            <th>No</th>
            <th>Nama</th>
        ...
        <?php if ($result && $result->num_rows > 0): $no = 1; ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <tr><td colspan="4">Belum ada data pengajuan izin nugas.</td></tr>
        <?php endif; ?>
    </table>
</div>
</body>
